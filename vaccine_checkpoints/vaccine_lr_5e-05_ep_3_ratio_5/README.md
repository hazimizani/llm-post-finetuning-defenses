...
| Total training samples | `11400 (user: 10400, anchor: 1000)` |
...
model = PeftModel.from_pretrained(base, "vaccine_checkpoints/vaccine_lr_5e-05_ep_3_ratio_5")
